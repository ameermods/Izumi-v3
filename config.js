...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~PAMhXqjq",
  MENU_URL: process.env.MENU_URL || "https://ik.imagekit.io/eypz/1725168688493_RSjq1BK9I.png",
  CAPTION: process.env.CAPTION || "Ameer",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "Ameer",
  BOT_NAME: process.env.BOT_NAME || "Ameer",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "💎𝑨𝒎𝒆𝒆𝒓 𝑿 𝑭𝒂𝒓𝒔𝒖💕",
  AUDIO_DATA: process.env.AUDIO_DATA || "Eʏᴘᴢ;Iᴢᴜᴍɪ-ᴠ3;https://i.imgur.com/cO0TZJv.jpeg",
  PROCESSNAME: process.env.PROCESSNAME || "Ameer-v1",
  AUTHOR: process.env.AUTHOR || "Ameer god",
